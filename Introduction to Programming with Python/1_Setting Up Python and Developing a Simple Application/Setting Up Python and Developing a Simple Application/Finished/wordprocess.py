...
class WordProcess:
    ...
    def __init__(self):
        ...
        try:
            ...
            sys.exit("Cannot read the word list file at " +
                     wordlist_path +
    ...
    def read_input_file(self, input_file_name):
        ...
        try:
            ...
            if file_size > 1e7:
                raise wordexceptions.FileTooBigError(os.path.getsize(input_file_name) / 1e6)
            if file_size == 0:
                raise wordexceptions.FileEmptyError()
        ...
        except wordexceptions.FileEmptyError:
            print("  The input file is empty. There is nothing to analyze.")
            return False

        except wordexceptions.FileTooBigError as arg:
    ...
    def save_list(self):
        ...
        log_filename = no_ext + "_results.txt"
